package javacourse.mq.activemq;
...
public class ActivemqApplication {
    ...
    public static void main(String[] args) {
        ...
        // 定义Destination
        Destination destination = new ActiveMQTopic("jxb.topic");
    ...
    public static void testDestination(Destination destination) {
        try {
            // 创建连接和会话
            ActiveMQConnectionFactory factory = new ActiveMQConnectionFactory("tcp://192.168.145.128:61616");
